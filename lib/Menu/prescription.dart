...
import 'perscription/current.dart';

class Perscription extends StatefulWidget {
  const Perscription({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _PerscriptionState createState() => _PerscriptionState();
}

class _PerscriptionState extends State<Perscription> {
  int _counter = 0;
  bool isOpened = false;
              ...
              child: Scaffold(
                appBar: AppBar(
                  ...
                  bottom: const TabBar(
                    ...
                    unselectedLabelColor: Color.fromARGB(255, 147, 178, 236),
                    labelColor: Color.fromARGB(255, 24, 58, 122),
                  ),
                  leading: IconButton(
                ...
                body: Container(
                  ...
                  child: TabBarView(
                    children: [
                      const current(), // contains the card with some text etc.
                      history(),
                    ],
                  ),
                ),
